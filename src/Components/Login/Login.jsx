            ...
            <div className="container">
                <div className="login__block">
                    <form className="Form">
                        ...
                        <input className="Form__input" type="text" placeholder={Lang.emailIn} />
                        <input className="Form__input" type="password" placeholder={Lang.passwordIn} />
                    ...
                    <div className="login__set">
                        ...
                        <label className="set__label">
                            <input className="set__input" type="checkbox" onClick={() => setDark(prev => !prev)} />
                        ...
                        <select className="lang__select" onChange={(e) => changeLang(e.target.value)}>
                            ...
                            <option className="lang__option" selected value="eng">eng</option>
                        </select>
                    </div>
                </div>
            </div>
